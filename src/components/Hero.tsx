...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative bg-[#F8F9FB] pt-12 pb-16 sm:pt-16 sm:pb-20 lg:pt-20 lg:pb-24 border-b border-[#DCE3EF] overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          {/* Small Badge */}
          <div className="inline-flex items-center justify-center gap-2 px-3 py-1 rounded-md bg-[#EAF1FF] border border-[#1247D6]/20 text-[#1247D6] text-xs font-semibold tracking-wider uppercase mb-5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#1247D6]"></span>
            <span>PARA JOGADORES DE VÔLEI</span>
          </div>
          ...
          {/* Product Mockup Centered (Single clean image) */}
